...
<p align="center">
  <img src="https://res.cloudinary.com/ds64xs2lp/image/upload/v1787480189/v1-0-3-release_lsbajc.svg" alt="v1.0.3 - Zodiac Intelligence and Numora Studio Beta Release" width="100%" />
</p>
...
- **Numora Studio beta:** v0.1.0-beta for macOS, Windows, and Linux with dedicated `tnsr_` Studio credentials
- **Release readiness:** refreshed dashboard, documentation, website, response metadata, and localized release messaging

Read the full release notes: [v1.0.3 changelog](https://docs.numerologyapi.com/changelog/changelog-v1-0-3/)
...
- **Studio product page:** https://numerologyapi.com/studio
...
## v1.0.3 Endpoint Families

The v1.0.3 release adds five dedicated zodiac reference endpoint families:

| Endpoint | Methods | Purpose |
| --- | --- | --- |
| `/api/v1/horoscope/sign/sun` | GET, POST | Sun-sign identity, vitality, purpose, compatibility, and sign facts |
| `/api/v1/horoscope/sign/moon` | GET, POST | Emotional, instinctive, intuitive, and inner-world sign readings |
| `/api/v1/horoscope/sign/ascendant` | GET, POST | Rising-sign public persona, first impressions, and outer expression |
| `/api/v1/horoscope/sign/modality` | GET, POST | Cardinal, fixed, and mutable modality intelligence |
| `/api/v1/horoscope/sign/element` | GET, POST | Fire, earth, air, and water elemental intelligence |
